...
mod layout_tests {
    ...
    impl LayoutManager {
            ...
            match self.direction {
                LayoutDirection::Vertical => {
                    ...
                    for child in &self.children {
                        let mut height = ((child.weight / total_weight) * available_height as f32) as u16;
                ...
                LayoutDirection::Horizontal => {
                    ...
                    for child in &self.children {
                        let mut width = ((child.weight / total_weight) * available_width as f32) as u16;
        ...
        pub fn get_total_min_size(&self) -> (u16, u16) {
            ...
            match self.direction {
                LayoutDirection::Vertical => {
                    let min_width = self.children.iter()
                        .filter_map(|c| c.min_width)
                        .max()
                        .unwrap_or(0);
                    let min_height = self.children.iter()
                        .filter_map(|c| c.min_height)
                        .sum::<u16>() + (self.children.len() - 1) as u16 * self.spacing;
    ...
    fn test_min_size_calculation() {
        ...
        manager.add_child(
            LayoutNode::new("child1".to_string())
                .with_min_size(20, 10)
        );
        manager.add_child(
            LayoutNode::new("child2".to_string())
                .with_min_size(30, 15)
        );
...
mod event_tests {
    ...
    fn test_event_handler_basic() {
        ...
        assert_eq!(handler.handle_key(KeyEvent::new(KeyCode::Char('x'))), Action::None);
    }
...
mod error_tests {
    ...
    impl ErrorManager {
        ...
        pub fn has_critical_errors(&self) -> bool {
            self.error_counts.get(&ErrorSeverity::Critical).copied().unwrap_or(0) > 0
        }
    }
    ...
    fn test_error_manager_basic() {
        ...
        assert_eq!(manager.get_error_count_by_severity(&ErrorSeverity::Medium), 1);
    }
    ...
    fn test_error_counts() {
        ...
        manager.report_error(TuiError::new("Low 1".to_string(), ErrorSeverity::Low, "test".to_string()));
        manager.report_error(TuiError::new("Low 2".to_string(), ErrorSeverity::Low, "test".to_string()));
        manager.report_error(TuiError::new("High 1".to_string(), ErrorSeverity::High, "test".to_string()));
        ...
        assert_eq!(manager.get_error_count_by_severity(&ErrorSeverity::Critical), 0);
...
mod integration_tests {
    ...
    fn test_complete_tui_workflow() {
        ...
        let mut widget = widget_tests::TestWidget::new(
            "main_widget".to_string(),
            "Main Widget".to_string(),
        );
        ...
        // Set up layout
        let node = layout_tests::LayoutNode::new("main_widget".to_string())
            .with_weight(1.0);
        ...
        // Test event handling
        let quit_key = event_tests::KeyEvent::new(event_tests::KeyCode::Char('q'))
            .with_ctrl();
    ...
    fn test_error_recovery_workflow() {
        ...
        let critical_error = error_tests::TuiError::critical(
        ...
        let critical_errors = error_manager.get_errors_by_severity(error_tests::ErrorSeverity::Critical);
