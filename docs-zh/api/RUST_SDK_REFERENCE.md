...
> **Rust Workflow Toolkit SDK 的全面参考手册**  
> *最后更新时间：2026-01-14*

## 概览

本文档提供了 Rust Workflow Toolkit 的完整 API 参考，包括核心 Trait、数据结构和使用示例。
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let workflow = WorkflowDefinition {
        ...
        description: Some("简单 Hello World 工作流".to_string()),
