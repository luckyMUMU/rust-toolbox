...
### 进行中的任务 🔄
- **任务 1.1**: 修复所有 unwrap() 使用（858 个 → < 100）
- **任务 1.2**: 统一错误处理模式
...
这将：
1. 读取 `.sisyphus/plans/final-work-plan.md`
2. 从第一个未完成的任务开始
...
```bash
cat .sisyphus/drafts/quick-start.md
```
...
### 代码质量验证 ⬜
- [ ] unwrap/expect 使用 < 100 个（当前 858 个）
- [ ] 所有文件行数 < 1,000 行
- [ ] 无重复代码
- [ ] 所有公共 API 有文档
- [ ] 错误处理完整
...
### 工作计划
- `.sisyphus/plans/final-work-plan.md` - 主要工作计划（推荐）
- `.sisyphus/plans/work-plan.md` - 工作计划
- `.sisyphus/plans/start-here.md` - 简化版工作计划

### 文档索引
- `.sisyphus/drafts/README.md` - 所有文档的索引
- `.sisyphus/drafts/quick-start.md` - 本快速开始指南
