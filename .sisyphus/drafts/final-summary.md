...
| 文件 | 用途 |
|------|------|
| `.sisyphus/plans/start-here.md` | 简化版工作计划（推荐） |
| `.sisyphus/plans/codebase-optimization.md` | 完整工作计划 |
| `.sisyphus/plans/rust-toolkit-optimization.md` | 详细工作计划（42 个任务） |
| `.sisyphus/plans/codebase-refinement.md` | 5 阶段改进计划 |
| `.sisyphus/drafts/final-summary.md` | 本总结报告 |
...
| `.sisyphus/drafts/summary.md` | 状态总结 |
...
### 代码质量验证 ⬜
- [ ] unwrap/expect 使用 < 100 个（当前 860 个）
- [ ] 所有文件行数 < 1,000 行
- [ ] 无重复代码
- [ ] 所有公共 API 有文档
- [ ] 错误处理完整
