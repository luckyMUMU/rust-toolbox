...
impl PerformanceManager {
    ...
    pub async fn record_stats(&self, component: &str, duration: Duration, memory_usage: MemoryUsage) {
        let mut stats = self.stats.entry(component.to_string()).or_insert_with(|| {
            PerformanceStats {
                execution_count: 0,
        ...
        // Update metrics
        self.metrics_collector.record_execution(component, duration, memory_usage).await;
    }
...
impl PerformanceMonitor {
    ...
    pub async fn finish(self) -> crate::Result<PerformanceResult> {
        ...
        let memory_usage = MemoryUsage {
            ...
            allocated: final_memory.total_bytes.saturating_sub(self.memory_snapshot.total_bytes),
        };
        ...
        // Record statistics
        self.manager.record_stats(&self.component, duration, memory_usage.clone()).await;
...
pub mod utils {
    ...
    pub fn create_optimized_channel<T>(buffer_size: usize) -> (tokio::sync::mpsc::Sender<T>, tokio::sync::mpsc::Receiver<T>) {
...
mod tests {
    ...
    async fn test_stats_recording() {
        ...
        manager.record_stats("test", Duration::from_millis(100), memory_usage).await;
